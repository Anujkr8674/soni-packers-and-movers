...
import type { JharkhandDistrict } from "../packers-movers-jharkhand/locationData";
import { districtRoute, localityRoute } from "../packers-movers-jharkhand/locationData";
import { localitySlug } from "../packers-movers-jharkhand/districtProfiles";
...
export function JharkhandStatePage({
  title,
  eyebrow,
  subtitle,
  heroImage,
    ...
    <>
      ...
      <section className="bg-white py-8 md:py-12">
        <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8 animate-fade-up">
          <p className="text-sm font-bold uppercase tracking-[0.34em] text-blue-700">Jharkhand service network</p>
      ...
      <section className="bg-slate-50 py-10 md:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="mt-3 text-3xl font-black text-slate-950 md:text-4xl">Why customers book us across Jharkhand</h2>
          </div>
      ...
      <section className="bg-white py-12 md:py-16">
        <div className="mx-auto max-w-6xl px-4 text-center sm:px-6 lg:px-8 animate-fade-up">
          ...
          <h2 className="mt-3 text-3xl font-black text-slate-950 md:text-4xl">Packers and movers available across Jharkhand</h2>
...
export function JharkhandDistrictPage({
  district,
  areaDisplayName,
  areaEyebrow,
  mapQuery,
